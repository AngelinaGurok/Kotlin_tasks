package kotlin_as_first.lesson1
 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (0.04445 * (vershoks + arshins
        * 16 + sagenes * 48))
...
fun angleInRadian(deg: Int, min: Int, sec: Int): Double {
   val angle = deg.toDouble() + min.toDouble() / 60 + sec.toDouble() / (60 * 60)
   return ((PI * angle) / 180)
}
